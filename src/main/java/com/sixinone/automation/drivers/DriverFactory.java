package com.sixinone.automation.drivers;
...
public class DriverFactory {
    ...
    public String downloadPath = ((System.getProperty(OS) == null || System.getProperty(OS).equals(WINDOWS))
    ...
    public ChromeOptions chromeOptions() {
        ...
        System.out.println("Download Path is print - " + downloadPath);
