...
//    }
    ...
    public void verifyFormCanBePrintedInPdfWithNameAsRW(String formName) throws AutomationException {
        ...
        switch (formName) {
            ...
            case "OC02":
                ...
                break;
            case "OC03":
                PageFactory.probateFormsOC03Page().verifyFormPrintedInPDFForm(formName);
                break;
            case "OC04":
                PageFactory.probateFormsOC04Page().verifyFormPrintedInPDFForm(formName);
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    public void verifyAllTheFieldsEnteredAreCorrectlyReflectedInTheRwPdf(String formName) throws Exception {
        ...
        switch (formName) {
            ...
            case "OC02":
                ...
                break;
            case "OC03":
                PageFactory.probateFormsOC03Page().verifyAllFieldsInDownloadedPDF();
                break;
            case "OC04":
                PageFactory.probateFormsOC04Page().verifyAllFieldsInDownloadedPDF();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    public void userVerifiesFileNumberFieldIsEditable(String formName) throws AutomationException, IOException, ParseException {
        ...
        switch (formName) {
            ...
            case "OC02":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().verifyFileNumberFieldIsEditable();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    public void userVerifiesSwappedPetitionerNamesAreReflectedOnUIAccordingly(String formName) throws AutomationException, IOException, ParseException {
        switch (formName) {
            ...
            case "OC04":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().verifySwappedPetitionerNamesAreReflectedOnUIAccordingly();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    public void userSavesSelectedBeneficiariesDetails(String formName) throws AutomationException {
        ...
        switch (formName) {
            ...
            case "OC04":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().userSavesSelectedBeneficiariesDetails();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    public void userVerifiesRestOfTheSelectedBeneficiariesAreDisplayedOnTheAttachment(String formName) throws AutomationException {
        ...
        switch (formName) {
            ...
            case "OC04":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().verifyRestOfTheSelectedBeneficiariesAreDisplayedOnTheAttachment();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    public void userClicksOnDisplayALLBeneficiariesOnAttachmentScheduleCheckbox() throws AutomationException {
        ...
        if (!DriverFactory.drivers.get().findElements(By.xpath(DISPLAY_ALL_BENE_ON_ATTACHMENT_BTN_V1)).isEmpty()) {
            xpath = DISPLAY_ALL_BENE_ON_ATTACHMENT_BTN_V1;
        } else if (!DriverFactory.drivers.get().findElements(By.xpath(DISPLAY_ALL_BENE_ON_ATTACHMENT_BTN_V2)).isEmpty()) {
            xpath = DISPLAY_ALL_BENE_ON_ATTACHMENT_BTN_V2;
        }
        ...
        if (xpath != null) {
            ...
            CommonSteps.logInfo("Display All Beneficiaries button not found.");
        }
    }
    ...
    public void userVerifiesAllTheBenyUsersAreDisplayedAsAPartOfAttachment(String formName) throws AutomationException {
        ...
        switch (formName) {
            ...
            case "OC04":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().verifyAllTheBenyUsersAreDisplayedAsAPartOfAttachment();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    public void userAddsInitials(String formName) throws IOException, ParseException, AutomationException {
        ...
        switch (formName) {
            ...
            case "OC04":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().userAddsInitials();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    public void userVerifiesNameAndAddressGetsDisappear(String formName) throws AutomationException {
        ...
        switch (formName) {
            ...
            case "OC04":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().verifyNameAndAddressGetsDisappear();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    public void userRemovesInitials(String formName) throws AutomationException {
        ...
        switch (formName) {
            ...
            case "OC04":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().userRemovesInitials();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    public void userVerifiesNameAndAddressOfTheBeneficiariesIsDisplayed(String formName) throws AutomationException {
        ...
        switch (formName) {
            ...
            case "OC04":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().verifyNameAndAddressOfTheBeneficiariesIsDisplayed();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    public void userVerifiesInterestIsAutoFetchedFromBenyWorksheet(String formName) throws AutomationException, IOException, ParseException {
        ...
        switch (formName) {
            ...
            case "OC04":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().verifyInterestIsAutoFetchedFromBenyWorksheet();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    @And("^user selects multiple petitioners for \"([^\"]*)\" form$")
    public void userSelectsMultiplePetitioners(String formName) throws AutomationException {
        CommonSteps.logInfo("user selects multiple petitioners for "+formName+" form");
        switch (formName) {
            case "OC02":
            ...
            case "OC04":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().userSelectsMultiplePetitioners();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    @Then("^user verifies out of the selected petitioners only 2 are visible on the form and rest are on the attachment for \"([^\"]*)\" form$")
    public void userVerifiesOutOfTheSelectedPetitionersOnlyAreVisibleOnTheFormAndRestAreOnTheAttachment(String formName) throws AutomationException, IOException, ParseException {
        switch (formName) {
            case "OC01":
            ...
            case "OC04":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().verify2PetitionersAreVisibleOnTheFormAndRestAreOnTheAttachment();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
        CommonSteps.logInfo("Verified that out of the selected petitioners only 2 are visible on the form and rest are on the attachment for "+formName+" form");
    }

    @And("^user swap the selected petitioner contacts for \"([^\"]*)\" form$")
    public void userSwapTheSelectedPetitionerContacts(String formName) throws AutomationException {
        CommonSteps.logInfo("user swap the selected petitioner contacts for "+formName+" form");
        switch (formName) {
            case "OC02":
            ...
            case "OC04":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().userSwapTheSelectedPetitionerContacts();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    @When("^user adds comments for \"([^\"]*)\" form$")
    public void userAddsComments(String formName) throws AutomationException, IOException, ParseException {
        CommonSteps.logInfo("user adds comments for "+formName+" form");
        switch (formName) {
            case "OC01":
    ...
    @Then("^user verifies comments are added and auto saved for \"([^\"]*)\" form$")
    public void userVerifiesCommentsAreAddedAndAutoSaved(String formName) throws AutomationException {
        CommonSteps.logInfo("Verified that comments are added and auto saved for "+formName+" form");
        switch (formName) {
            case "OC01":
    ...
    public void userVerifiesByDefaultPageShouldIsOpenedAndCorrectCountyNameIsFetchedAndDisplayedAtTheTopOfTheForm(String formName) throws AutomationException {
        CommonSteps.logInfo("Verified that by default page 1 should is opened and correct county name is fetched and displayed at the top of the "+formName+" form");
        switch (formName) {
            case "OC02":
                ...
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().verifyByDefaultPageShouldIsOpenedAndCorrectCountyNameIsFetchedAndDisplayedAtTheTopOfTheForm();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    @Then("^user verifies selected names of petitioner are displayed with address on \"([^\"]*)\" form$")
    public void userVerifiesSelectedNamesOfPetitionerAreDisplayedWithAddress(String formName) throws AutomationException {
        CommonSteps.logInfo("Verified that selected names of petitioner are displayed with address on "+formName+" form");
        switch (formName) {
            case "OC02":
                PageFactory.probateFormsOC02Page().verifySelectedNamesOfPetitionerAreDisplayedWithAddress();
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().verifySelectedNamesOfPetitionerAreDisplayedWithAddress();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
    ...
    @Then("^user verifies estate's name is auto fetched and correctly displayed on \"([^\"]*)\" form$")
    public void userVerifiesEstateSNameIsAutoFetchedAndCorrectlyDisplayed(String formName) throws AutomationException {
        CommonSteps.logInfo("Verified that estate's name is auto fetched and correctly displayed on "+formName+" form");
        switch (formName) {
            case "OC02":
                PageFactory.probateFormsOC02Page().verifyEstateSNameIsAutoFetchedAndCorrectlyDisplayed();
                break;
            case "OC05":
                PageFactory.probateFormsOC05Page().verifyEstateSNameIsAutoFetchedAndCorrectlyDisplayed();
                break;
            default:
                throw new AutomationException("Unsupported form name: " + formName);
        }
