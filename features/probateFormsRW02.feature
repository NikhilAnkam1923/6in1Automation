...
Feature: 6in1 probate form RW02 Feature
  ...
  Scenario: Verify RW02 form
    ...
    Then user verifies correct county name is fetched from the decedent info
     #Verify, names of fiduciary type of contact is displayed at the top.
    Then user verifies Fiduciary type of contacts are displayed at the top
     #Verify, if the names exceed the line, contacts are displayed in the attachment.
    ...
    Then user verifies multiple aka names can be added separated by comma
     #Verify, values can be selected from the dropdown of "Estimate of value of decedents property at death"
